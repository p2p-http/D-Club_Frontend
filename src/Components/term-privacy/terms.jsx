      ...
      <div className="w-full sm:w-3/4 md:max-w-4xl bg-gray-900 rounded-xl shadow-lg px-6 sm:px-10 py-8 mt-16 sm:mt-36">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 mt-2">
            Welcome to{" "}
            <span className="text-[#FFD700] font-semibold">D-Club</span>! 🎉 By
            using our platform, you agree to follow our Terms of Service. If you
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300 mt-2">
            <li>
              You must be <strong>18 years or older</strong> to use D-Club.
            </li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300 mt-2">
            <li>
              Keep your account <strong>secure</strong> and do not share login
              credentials.
            </li>
            <li>
              Suspicious activity may result in{" "}
              <strong>suspension or termination</strong> of your account.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300 mt-2">
            <li>
              Engage in <strong>illegal activities</strong> or harassment.
            </li>
            <li>Post hate speech, discrimination, or spam.</li>
            <li>
              Create <strong>fake profiles</strong> or misleading information.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold text-white">
            5. Party Mode & Club Partner Matching
          </h2>
          <p className="text-gray-300 mt-2">
            D-Club helps users find <strong>club partners</strong> based on
            preferences. However:
          </p>
          <ul className="list-disc list-inside text-gray-300 mt-2">
            <li>We do not guarantee successful matches or user behavior.</li>
            <li>
              Users should always <strong>prioritize safety</strong> when meeting
              someone.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 mt-2">
            ...
            <strong
              ...
              className="cursor-pointer hover:text-[#FF9684]"
            >
              Privacy Policy
            </strong>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 mt-2">
            We reserve the right to suspend or remove accounts that violate our
            policies.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 mt-2">
            D-Club is not responsible for user interactions. Users must exercise
