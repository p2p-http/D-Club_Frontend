...
const Prostack = () => {
    ...
    return (
        <div className="main flex flex-col items-center justify-center min-h-[65vh] space-y-6 sm:space-y-8 pb-6 sm:pb-10 pt-10 sm:pt-20 px-3 sm:px-6 bg-black text-white">
            {/* Profile Section */}
            <div className="flex flex-col w-full max-w-md sm:max-w-3xl space-y-6 p-4 rounded-2xl bg-[#312F2F] shadow-md">
                {/* Profile Card */}
                <div className="profile_pic relative flex flex-col sm:flex-row sm:items-center sm:justify-center w-full gap-4 sm:gap-11 p-4 sm:p-6">
                    {/* Profile Image Section */}
                    <div className="photo-icon relative w-24 h-24 sm:w-32 sm:h-32 items-center justify-items-center">
                        <img
                    ...
                    {/* Name, Bio & Button */}
                    <div className="name,bio,btn flex flex-col justify-start sm:items-start space-y-3 sm:text-start">
                        ...
                        <div className="text-[#868181] justify-center items-center  text-xs sm:text-sm flex flex-row gap-2 ">
                            <p className="">{user.dateOfBirth ? new Intl.DateTimeFormat("fr-CA").format(new Date(user.dateOfBirth)) : "Not Selected"}</p>
                            <p>|</p>
                ...
                <div className="bg-[#1b191b] rounded-xl p-4 sm:p-6 text-center shadow-sm flex flex-col space-y-4">
                    ...
                    <div className="socialp flex flex-col itemsend">
