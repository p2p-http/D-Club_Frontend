      ...
      <div className="box w-full max-w-[90%] md:max-w-[70%] lg:max-w-[50%] bg-[#312F2F] flex justify-center items-center rounded-xl p-4 sm:p-6 md:p-12 shadow-[5px_5px_15px_rgba(0,0,0,0.3)] shadow-gray-600 drop-shadow-xl">
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4 w-full max-w-sm">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="pt-2 text-xs text-gray-400"> By clicking Continue, you agree to our <span onClick={() => navigate("/terms")}  className="text-[#ffc45e] cursor-pointer hover:underline">Terms</span> and <span onClick={() => navigate("/auth/login")} className="text-[#ffc45e] cursor-pointer hover:underline" >Privacy Policy</span></p>
