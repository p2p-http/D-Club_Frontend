...
const ForgotPass = () => {
  ...
  return (
    <div className="flex flex-col text-white justify-center items-center min-h-screen gap-6 px-4 sm:px-6 lg:px-8">
      ...
      {/* Box */}
      <div className="w-full max-w-md bg-[#312F2F] flex flex-col justify-center items-center rounded-xl p-6 sm:p-8 shadow-[5px_5px_15px_rgba(0,0,0,0.3)] shadow-gray-600 drop-shadow-xl">
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4 w-full">
          ...
          <p className="text-xs mt-2 text-gray-400 flex justify-center">
            ...
            <span
              ...
              className="text-[#FFD700] cursor-pointer hover:underline ml-1"
            >
              Log In
            </span>
          </p>
