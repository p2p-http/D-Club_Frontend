    ...
    return (
        <div className="min-h-screen text-white flex flex-col items-center justify-center px-4 py-12 ">
            ...
            <motion.h2 
                ...
                className="text-4xl font-bold mb-12 text-[#FFD700] sm:text-5xl tracking-tight"
            >
                Testimonials
            </motion.h2>

            <div className="w-full max-w-md sm:max-w-2xl lg:max-w-4xl relative">
                ...
                <motion.div
                    ...
                    className="bg-[#2A2A2A] w-full h-auto min-h-[400px] p-8 sm:p-10 rounded-3xl shadow-xl border border-[#3D3D3D] hover:border-[#FFD700]/30 transition-all duration-300"
                >
